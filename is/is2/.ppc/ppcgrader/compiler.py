    ...
    def compile(self,
        ...
        try:
            ...
            output = CompilerOutput(
                '',
                f'Compilation took longer than {timeout}s, so the process was killed.\nYou can disable the compile-time check with --no-timeout.',
                -1)
...
'''
                if platform.machine() != 'arm64':
                    message += '''
Alternatively, you can try to install GCC and use it instead of Clang:
...
I should be able to find the right packages and compilers then!'''
            ...
            try:
                ...
                message = '''It seems that you have Homebrew installed, which is good!
